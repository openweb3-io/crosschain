...
func TestGetAddressFromPublicKey(t *testing.T) {
	...
	require.NoError(t, err)
	require.Equal(t, xc_types.Address("0x5891906fEf64A5ae924C7Fc5ed48c0F64a55fCe1"), address)
	...
	require.NoError(t, err)
	require.Equal(t, xc_types.Address("0xCc10cd3f77d370F7893E94e4eEb48Fb9553B7a5B"), address)
}
...
func TestGetAddressFromPublicKeyErr(t *testing.T) {
	...
	require.Equal(t, xc_types.Address(""), address)
...
func TestGetAllPossibleAddressesFromPublicKey(t *testing.T) {
	...
	require.Equal(t, xc_types.Address("0x5891906fEf64A5ae924C7Fc5ed48c0F64a55fCe1"), addresses[0].Address)
	require.Equal(t, xc_types.AddressTypeDefault, addresses[0].Type)
}
