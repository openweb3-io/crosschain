...
import (
	...
	"github.com/openweb3-io/crosschain/client/services/figment"
	testutil "github.com/openweb3-io/crosschain/testutil/types"
...
func (cli *Client) FetchStakingInput(ctx context.Context, args xcbuilder.StakeArgs) (xc_types.StakeTxInput, error) {
	...
	gasLimit, err := cli.rpcClient.SimulateGasWithLimit(ctx, args.GetFrom(), exampleTx.(*tx.Tx), asset)
	if err != nil {
		return nil, err
	}
...
func (cli *Client) FetchActiveValidators(ctx context.Context, from xc_types.Address) ([][]byte, error) {
