...
func FromSigner(ctx context.Context, api TonAPI, signer signer.Signer, version VersionConfig) (*Wallet, error) {
...
func FromAddress(ctx context.Context, api TonAPI, addr *address.Address, version VersionConfig) (*Wallet, error) {
	var subwallet uint32 = DefaultSubwallet
...
func FromPublicKey(api TonAPI, pubkey ed25519.PublicKey, version VersionConfig) (*Wallet, error) {
	var subwallet uint32 = DefaultSubwallet
	...
	addr, err := AddressFromPubKey(pubkey, version, subwallet)
	if err != nil {
		return nil, err
	}
...
func (w *Wallet) GetSubwallet(ctx context.Context, subwallet uint32) (*Wallet, error) {
	...
	addr, err := AddressFromPubKey(publicKey, w.ver, subwallet)
	if err != nil {
		return nil, err
	}
...
/*
func (w *Wallet) Send(ctx context.Context, message *Message, waitConfirmation ...bool) (tx *tlb.Transaction, block *ton.BlockIDExt, inMsgHash []byte, err error) {
...
func (w *Wallet) SendMany(ctx context.Context, messages []*Message, waitConfirmation ...bool) (tx *tlb.Transaction, block *ton.BlockIDExt, inMsgHash []byte, err error) {
	return w.sendMany(ctx, messages, waitConfirmation...)
}
*/
...
/*
func (w *Wallet) TransferNoBounce(ctx context.Context, to *address.Address, amount tlb.Coins, comment string, waitConfirmation ...bool) (tx *tlb.Transaction, block *ton.BlockIDExt, inMsgHash []byte, err error) {
...
/*
func (w *Wallet) Transfer(ctx context.Context, to *address.Address, amount tlb.Coins, comment string, waitConfirmation ...bool) (tx *tlb.Transaction, block *ton.BlockIDExt, inMsgHash []byte, err error) {
...
/*
func (w *Wallet) TransferWithEncryptedComment(ctx context.Context, to *address.Address, amount tlb.Coins, comment string, waitConfirmation ...bool) (tx *tlb.Transaction, block *ton.BlockIDExt, inMsgHash []byte, err error) {
...
/*
func (w *Wallet) transfer(ctx context.Context, to *address.Address, amount tlb.Coins, comment string, bounce bool, waitConfirmation ...bool) (tx *tlb.Transaction, block *ton.BlockIDExt, inMsgHash []byte, err error) {
...
func (w *Wallet) DeployContract(ctx context.Context, amount tlb.Coins, msgBody, contractCode, contractData *cell.Cell, waitConfirmation ...bool) (*address.Address, error) {
	...
	if _, _, _, err = w.Send(ctx, &Message{
		Mode: PayGasSeparately + IgnoreErrors,
		InternalMessage: &tlb.InternalMessage{
			IHRDisabled: true,
			Bounce:      false,
