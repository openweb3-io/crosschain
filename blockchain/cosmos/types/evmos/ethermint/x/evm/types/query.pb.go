...
type QueryBaseFeeResponse struct {
	...
	BaseFee *cosmossdk_io_math.Int `protobuf:"bytes,1,opt,name=base_fee,json=baseFee,proto3,customtype=github.com/cosmos/cosmos-sdk/math.Int" json:"base_fee,omitempty"`
}
