...
import (
	...
	"github.com/openweb3-io/crosschain/blockchain/cosmos/client"
...
func TestFetchTxInput(t *testing.T) {
	...
	vectors := []struct {
		...
		{
			xc.ChainConfig{Chain: "XPLA", ChainCoin: "axpla", ChainPrefix: "xpla", Blockchain: xc.BlockchainCosmosEvmos},
	...
	vectors := []struct {
	...
	}{
		{
			...
			xc.LegacyTxInfo{
				...
				Amount:          xc.NewBigIntFromUint64(5000000),
				Fee:             xc.NewBigIntFromUint64(1000000),
				BlockIndex:      2754866,
		...
		},
		{
			...
			xc.LegacyTxInfo{
				...
				Amount:          xc.NewBigIntFromUint64(5000000000000000),
				Fee:             xc.NewBigIntFromUint64(112200000000000000),
				BlockIndex:      1359533,
		...
		},
		{
			...
			xc.LegacyTxInfo{
				...
				Amount:          xc.NewBigIntFromUint64(18480304),
				Fee:             xc.NewBigIntFromUint64(583610850000000000),
				BlockIndex:      4855691,
				BlockTime:       1669849454,
				Confirmations:   198,
				Status:          0,
				Sources: []*xc.LegacyTxInfoEndpoint{
					...
					},
					{
						Address:         "xpla1cdty03fzqzqpkvf4zpmpl9rnlffjeey7fa5n47",
						ContractAddress: "xpla1hz3svgdhmv67lsqlduu0tcnd3f75c0xr0mu48l6ywuwlz43zssjqc0z2h4",
						Amount:          xc.NewBigIntFromUint64(190519),
					},
					{
						Address:         "xpla1cdty03fzqzqpkvf4zpmpl9rnlffjeey7fa5n47",
						ContractAddress: "xpla1hz3svgdhmv67lsqlduu0tcnd3f75c0xr0mu48l6ywuwlz43zssjqc0z2h4",
					...
					},
					{
						Address:         "xpla1cdty03fzqzqpkvf4zpmpl9rnlffjeey7fa5n47",
						ContractAddress: "xpla1hz3svgdhmv67lsqlduu0tcnd3f75c0xr0mu48l6ywuwlz43zssjqc0z2h4",
						Amount:          xc.NewBigIntFromUint64(95260),
					},
					{
						Address:         "xpla1cdty03fzqzqpkvf4zpmpl9rnlffjeey7fa5n47",
						ContractAddress: "xpla1hz3svgdhmv67lsqlduu0tcnd3f75c0xr0mu48l6ywuwlz43zssjqc0z2h4",
...
func TestFetchBalance(t *testing.T) {
	...
	vectors := []struct {
		...
		},
		{
			// XPLA
			&xc.ChainConfig{Chain: "XPLA", ChainCoin: "axpla", ChainPrefix: "xpla"},
			&xc.TokenAssetConfig{Asset: "USDC", Contract: "terra1pepwcav40nvj3kh60qqgrk8k07ydmc00xyat06", Decimals: 6},
			"xpla1hdvf6vv5amc7wp84js0ls27apekwxpr0ge96kg",
		...
		{
			&xc.ChainConfig{Chain: "INJ", ChainCoin: "uinj", ChainPrefix: "inj"},
			// Injective peggy asset
			&xc.TokenAssetConfig{Asset: "USDT", Contract: "peggy0x3506424F91fD33084466F402d5D97f05F8e3b4AF", Decimals: 6},
