...
func (s *ClientTestSuite) TestFetchTxInput() {
	...
	for _, v := range testcases {
		...
		defer close()
		cfg := &xc.ChainConfig{Chain: xc.BTC, URL: server.URL, Network: "testnet", AuthSecret: "1234", Provider: string(client.Blockchair), ChainMinGasPrice: 12}
...
func (s *ClientTestSuite) TestFetchTxInputUnconfirmedUtxo() {
	...
	defer close()
	cfg := &xc.ChainConfig{Chain: xc.BTC, URL: server.URL, Network: "testnet", AuthSecret: "1234", Provider: string(client.Blockchair)}
